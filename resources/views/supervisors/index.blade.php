      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active"><a class="dropdown-item e-coloresx text-center te4"
              href="{{url('supervisors/padron')}}">Padrón</a></li>
          <li class="nav-item"><a class="dropdown-item e-coloresx text-center te4"
              href="{{url('banx/banx')}}">Historial</a>
          </li>
      ...
      <div role="row">
        ...
        <div class="jumbotron col-9 col-lg-9 col-md-9 col-sm-9 col-xs-9 mx-auto autom rest3">
          ...
          <p class="text-center e-estilo-p">El sistema de padrón de apicultores Xixhá, tiene la finalidad de llevar la
            ...
            guerrero.</p>
          <p class="text-center"><a class="btn btn-primary btn-lg" href="{{url('supervisors/padron')}}" role="button">Ir
              a Padrón &raquo;</a></p>
        </div>
      </div>
    </div>
