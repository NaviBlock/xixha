    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">              
              <a class="dropdown-item e-coloresx" href="{{url('supervisors/padron')}}"  >Padrón <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="dropdown-item e-coloresx disabled" href="/">Grafico</a>
            </li>  
          </ul>
      ...
      <div class="container-fliud">
        <main role="main">                
          <div class="jumbotron">
            <!--Titulo principal-->
            <h1 class="text-center display-4 e-coloresx">Hola, Amigo Supervisor!</h1>
          ...
          <div class="col-md-4">
            <div class="card text-center">
              <div class="card-body">
                ...
                <p class="card-text text-justify">Las mieles Xixhá provienen de la región, Costa Chica de Guerrero, se caracterizan por ser mieles muy aromáticas, un poco obscuras, comparadas con las mielesdel altiplano, pero con aromas y sabores muy marcados, intensos o suaves, pero definidos que se han ganado la aceptaciónde los consumidores.</p>
          ...
          <div class="col-md-4">
            <div class="card text-center">        
              <div class="card-body">
                ...
                <p class="card-text text-justify">Nuestras mieles tienen aplicación nutricional, pueden degustarse directamente, en mesa, en platillos en cocina, en panaderías, pastelerías, en confitería (caramelos, granola, etc.), en cosméticos (cremas, shampoo, etc.), en coadyuvantes para la salud, jarabes, elaboraciónde cervezas, etc.</p>
      ...
      <footer class="container-fliud">
        <a href="http://xixha.com"><p class="e-coloresx e-footer">&copy;Xixhá 2019</p></a>
      </footer>      
