      ...
      <div class="row">
        ...
        <div class="jumbotron col-9 col-lg-9 col-md-9 col-sm-9 col-xs-9 mx-auto autom">
          ...
          <p class="text-center e-estilo-p">El sistema de padrón de apicultores Xixhá, tiene la finalidad de llevar la
            ...
            guerrero.</p>
          <p class="text-center"><a class="btn btn-primary btn-lg" href="{{url('users/padron')}}" role="button">Ir a
              Padrón &raquo;</a></p>
        </div>
      </div>
    </div>
            ...
            <div class="col-md-4 ">
              <div class="card text-center">
                <div class="card-body e-element-2 ">
                  ...
                  <p class="card-text text-justify e-element-1">Las mieles Xixhá provienen de la región, Costa Chica de
                    Guerrero, se caracterizan por ser mieles muy aromáticas, un poco obscuras, comparadas con las
                    mielesdel altiplano, pero con aromas y sabores muy marcados, intensos o suaves, pero definidos que
                    se
                    han ganado la aceptaciónde los consumidores.</p>
            ...
            <div class="col-md-4">
              <div class="card text-center">
                <div class="card-body e-element-2">
                  ...
                  <p class="card-text text-justify e-element-1">Es un proyecto estratégico porque plantea una solución
                    común a una problemática común, de bajo costo, alto impacto social, que genera empleo, arraigo
                    comunitario, patrimonio familiar, forma agentes de cambio social guardianes de la naturaleza, al
                    preservar los recursos de la selva y el bosque; tierra, agua, flora, fauna, oxigeno, combate al
                    cambio
                    climático..</p>
            ...
            <div class="col-md-4">
              <div class="card text-center">
                <div class="card-body e-element-2">
                  ...
                  <p class="card-text text-justify e-element-1">Nuestras mieles tienen aplicación nutricional, pueden
                    degustarse directamente, en mesa, en platillos en cocina, en panaderías, pastelerías, en confitería
                    (caramelos, granola, etc.), en cosméticos (cremas, shampoo, etc.), en coadyuvantes para la salud,
                    jarabes, elaboraciónde cervezas, etc.</p>
                  <a class="btn btn-primary"
