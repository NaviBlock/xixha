                    ...
                    {{ csrf_field() }}
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12 ml-sm-auto col-lg-12 mx-auto">
                                <input id="email" type="email" class="form-control e-table e-border" name="email" value="{{ old('email') }}">
                                @if ($errors->has('email'))
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12 ml-sm-auto col-lg-12 mx-auto">
                                    <input id="password" type="password" class="form-control e-table e-border" name="password">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4 col-md-12 text-center justify-content-center align-self-center">
                                    <button type="submit" class="btn btn-primary e-titulo">
