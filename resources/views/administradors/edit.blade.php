<?php/*
|--------------------------------------------------------------------------
| Vista administradors/edit
|--------------------------------------------------------------------------
| En esta vista llamamos un formulario que contiene informacion del administradors,
| Este proceso se obtiene la realizar una consulta en el controlador administradorsController 
| y realizamos update a los datos de la tabla administradors
|
*/?>
		...
		<div class="main col-md-12 ml-sm-auto col-lg-12 py-4">
			...
			<div class="form-group amber-textarea active-amber-textarea-2 input-group e-border text-center">
				<div class="input-group mx-auto">
					<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 mx-auto">
						<div class="input-group-prepend">
							<span class="text-center input-group-text btn btn-warning" id="basic-addon102">Nombre del
								Apicultor</span>
							...
							<input type="text" name="apellidopa" required value="{{$persona->apellidopa}}"
								disabled="true" class="input-group-text e-border md-textarea form-control lineA"
								placeholder="Apellido Parteno..." aria-describedby="basic-addon102">
							<input type="text" name="apellidoma" required value="{{$persona->apellidoma}}"
								disabled="true" class="input-group-text e-border md-textarea form-control lineA"
			...
			<div class="form-group amber-textarea active-amber-textarea-2 input-group e-border text-center">
				<div class="input-group mx-auto">
					<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 mx-auto">
						<div class="input-group-prepend">
							<span class="input-group-text btn btn-warning " id="basic-addon113">Tipo de
								Certificación</span>
			...
			<div class="form-group amber-textarea active-amber-textarea-2 input-group e-border text-center">
				<div class="input-group mx-auto">
					<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 mx-auto">
						<div class="input-group-prepend">
							<span class="input-group-text btn btn-warning" id="basic-addon114">Temporada de
								Cosecha</span>
			...
			<div class="form-group amber-textarea active-amber-textarea-2 input-group e-border text-center">
				<div class="input-group mx-auto">
					<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 mx-auto">
						<div class="input-group-prepend">
							<span class="input-group-text btn btn-warning" id="basic-addon115">Numeros de Colmenas o
								Chapetas</span>
			...
			<div class="form-group amber-textarea active-amber-textarea-2 input-group e-border text-center">
				<div class="input-group mx-auto">
					<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 mx-auto">
						<div class="input-group-prepend">
							<span class="input-group-text btn btn-warning" id="basic-addon119">Clave de
								Rasteabilidad</span>
			...
			<div class="form-group amber-textarea active-amber-textarea-2 input-group e-border text-center">
				<div class="input-group mx-auto">
					<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 mx-auto">
						<div class="input-group-prepend">
							<span class="input-group-text btn btn-warning" id="basic-addon120">Localización de los
								Apiarios</span>
