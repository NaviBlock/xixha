...
| Vista story/show
|--------------------------------------------------------------------------
| En esta vista llamamos un formulario que contiene informacion del story,
| Este proceso se obtiene la realizar una consulta en el controlador storyController 
| 
*/?>
													...
													<div class="input-group-prepend">
														<div
															...
															<div class="table-responsive">
																<table
																	class="table table-condensed table-sm text-white">
