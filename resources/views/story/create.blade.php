...
<div class="collapse container-fluid row main col-md-12 col-sm-auto col-lg-12 py-4" id="p-id">
	<div class="card card-body">
		...
		<div class="form-group amber-textarea active-amber-textarea-2 input-group e-border text-center">
			<div class="input-group mx-auto">
				<div class="input-group-prepend col-lg-11 col-md-11 col-sm-11 col-xs-11 mx-auto">
					<input type="text" name="id_ref" value="{{$stories->id_ref}}" id="id_ref"
						class="md-textarea form-control lineA e-color-c" placeholder="{{id_ref}}">
				</div>
			</div>
		</div>
		...
		<div class="form-group amber-textarea active-amber-textarea-2 input-group e-border text-center">
			<div class="input-group mx-auto">
				<div class="input-group-prepend col-lg-11 col-md-11 col-sm-11 col-xs-11 mx-auto">
					<input type="text" name="cantidad" value="{{old('cantidad')}}" id="cantidad"
						class="md-textarea form-control lineA e-color-c" placeholder="Cantidad">
				</div>
			</div>
		</div>
		...
		<div class="form-group amber-textarea active-amber-textarea-2 input-group e-border text-center">
			<div class="input-group mx-auto">
				<div class="input-group-prepend col-lg-11 col-md-11 col-sm-11 col-xs-11 mx-auto">
					<input type="date" name="fechaRegistro" value="{{old('fechaRegistro')}}" id="fechaRegistro"
						class="md-textarea form-control lineA e-color-c" placeholder="Fecha de Registro">
				</div>
			</div>
		</div>
