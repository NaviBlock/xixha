		...
		<div class="main col-md-12 ml-sm-auto col-lg-12 py-4">
			...
			<div class="form-group amber-textarea active-amber-textarea-2 input-group e-border text-center">
				<div class="input-group mx-auto">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mx-auto">
						<div class="input-group-prepend">
							<select name="rol" value="{{old('rol')}}" id="rol"
								class="md-textarea form-control lineA e-border">
				...
				<div class="input-group mx-auto">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mx-auto">
						<div class="input-group-prepend">
							...
							<select name="is_admin" value="{{old('is_admin')}}" id="is_admin"
								class="md-textarea form-control lineA e-border">
				...
				<div class="input-group mx-auto">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mx-auto">
						<div class="input-group-prepend">
							...
							<input id="pin" type="text" require class="md-textarea form-control lineA e-border"
								name="pin" min="5" max="100">
						</div>
					</div>
				</div>
			</div>
			<div class="form-group amber-textarea active-amber-textarea-2 input-group e-border text-center aolq py-4"
				id="datoy">
				<div class="input-group mx-auto">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mx-auto">
						<div class="input-group-prepend">
