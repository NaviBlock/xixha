        ...
        <ul class="navbar-nav">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <a class="dropdown-item btn btn-warning btn-responsive text-center te1" href="{{url('administradors')}}">Inicio</a>
              <a class="dropdown-item btn btn-primary btn-responsive text-center te2" href="{{url('administradors/padron')}}">Padrón Apicultores</a>
              <a class="dropdown-item btn btn-success btn-responsive text-center te2" href="{{url('administradors/create')}}">Registro Apicultor</a>
              <a class="dropdown-item btn btn-danger btn-responsive text-center te3"  href="{{url('/logout')}}">Salir</a>
            </div>
          </li>
        </ul>
      </div>
