      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <a class="dropdown-item btn btn-primary text-center te1" href="{{url('home')}}">Inicio</a>
            <a class="dropdown-item btn btn-warning text-center" href="{{url('padron')}}">Padrón</a>
            <a class="dropdown-item btn btn-danger text-center"  href="{{url('logout')}}">Salir</a>
          </div>
        </li>
      </ul>
    </div>
