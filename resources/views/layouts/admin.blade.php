    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Xixha</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Alejandro Hernández Valle</span>
                </a>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019-2020 <a href="www.xixha.com">xixhá</a>.</strong> All rights reserved.
      </footer>
