...
<body>
  <div class="container-fluid">
      ...
      <div class="row lapix-e">
        ...
        <div class="card text-center lapix ">
          <div class="card-body e-element-2 ">
            <h5 class="card-title text-primar lapix1">Mieles Xixhá</h5>
            <p class="card-text text-justify e-element-1 lapix1">Las mieles Xixhá provienen de la región, Costa Chica de
    ...
    <!--script src="{ {asset('js/jsx/jquery-3.3.1.slim.min.js')}}"></script-->
