...
|   por parte del administrador permite añadir objetos articulos.
*/
class ArticuloController extends Controller{
    ...
    */
    ...
    |   y lo redirecciona a la vista almacen/articulo al administrador
    */	   
	...
	|   recibe como parametro un $id para la funcion index.
    */
	...
	|   recibe como parametro un $id que permite modificar los datos con la 
	|   funcion update.
    */	   
