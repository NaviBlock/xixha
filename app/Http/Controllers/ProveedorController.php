...
*/
    ...
    */
        public function store(PersonaFormRequest $request){
            ...
            | Componente imagenes
            |--------------------------------------------------------------------------
            | Si la condición es true, tomamos el archivo y su extension
            | generamos un folio se renombra su nombre
            |--------------------------------------------------------------------------
            */
    ...
    */  
    ...
    | y lo redirecciona a la vista proveedor
    */
